...
<head>
    ...
    <meta name="description" content="View all products of type: <?php echo htmlspecialchars($type); ?>." />
    ...
    <div class="container">
        <nav class="container py-3" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a class="text-decoration-none fw-medium" style="color:black" href="index.php?route=product-type&category_id=<?php echo urlencode($categoryId); ?>">Category: <?php echo htmlspecialchars($categoryName); ?></a></li>
            ...
            <div class="content-layout">
                ...
                <div>
                    <div class="d-flex justify-content-between mb-4">
                        ...
                        include __DIR__ . '/partials/add-product.php';
                        ?>
                    </div>
